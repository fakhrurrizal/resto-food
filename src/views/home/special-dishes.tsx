...
const SpecialDisheh = () => {
    ...
    return (
        <section className=" bottom-0 py-1  left-0 w-full text-black px-5 sm:px-6 lg:px-10  p-4 block md:flex justify-between items-center">
            <div className="items-center px-2 mt-2 md:mt-16 md:px-14 py-14 w-full ">
                <div>
                ...
                <div className="grid grid-cols-2 gap-2 md:gap-8 mt-9">
                    ...
                    >
                        <Image src="/assets/images/ayam-taliwang.png" height={700} width={700} alt="Ayam Taliwang" className="rounded-2xl border-2 border-primary  " style={{ height: "100%" }} />
                        <div
                            className={`absolute hidden md:flex top-0 left-0 w-full h-full   justify-center items-center transition-opacity duration-300 ${isHovered.product_1 ? 'opacity-100' : 'opacity-0'}`}
                        >
                            <div className="bg-white bg-opacity-80 px-7 py-5 rounded-md ">
                                ...
                                <div className="flex justify-between mt-2 gap-10">
                                    ...
                                    <div className="font-extrabold text-md">{formatToRupiah(20)}K</div>
                                </div>
                                <div className="mt-5 ">
                    ...
                    <div>
                        <div className="grid grid-rows-2 grid-flow-col gap-1">
                            ...
                            >
                                <Image src="/assets/images/makanan-1.png" height={100} width={700} alt="Ayam Taliwang" className="rounded-2xl border-2 border-primary  " style={{ height: "100%" }} />
                                <div
                            ...
                            <div className="grid grid-cols-2 gap-2 ">
                                ...
                                >
                                    <Image src="/assets/images/rendang.png" height={100} width={600} alt="Ayam Taliwang" className="rounded-2xl border-2 border-primary  " style={{ height: "100%" }} />
                                    <div
                                    ...
                                    >
                                        <div className="bg-white bg-opacity-75 px-7 py-5 rounded-md ">
                                            ...
                                            <div className="flex justify-between mt-2 gap-10">
                                                <span className="font-extrabold text-md">Rendang Sapi</span>
                                ...
                                >
                                    <Image src="/assets/images/sate.png" height={100} width={600} alt="Ayam Taliwang" className="rounded-2xl border-2 border-primary  " style={{ height: "100%" }} />
                                    <div
                                    ...
                                    >
                                        <div className="bg-white bg-opacity-75 px-7 py-5 rounded-md ">
                                            ...
                                            <div className="flex justify-between mt-2 gap-10">
                                                <span className="font-extrabold text-md">Sate Ayam</span>
                                                <div className="font-extrabold text-md">{formatToRupiah(15)}K</div>
                                            </div>
                                            <div className="mt-5 ">
                                                <button className="bg-white px-5 border border-primary text-sm py-1 flex rounded-[3px] hover:bg-primary hover:text-white">Pesan </button>
